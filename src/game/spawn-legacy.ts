/**
 * src/game/spawn-legacy.ts — Legacy IID obstacle spawner (Phase 1 / pre-chunk).
 *
 * This file is the original Phase 1 spawner preserved for A/B testing.
 * Load with URL param ?legacy=1 to bypass the ChunkPicker.
 * Will be deleted in the release AFTER Phase 2 is validated.
 *
 * Original file: src/game/spawn.ts
 *
...
export function maybeSpawnLegacy(state: GameState, canvasW: number): void {
